...
namespace math {
    ...
    public:
        ...
        tmat44(T _m1, T _m2, T _m3, T _m4, T _m5, T _m6, T _m7, T _m8, T _m9, T _m10, T _m11, T _m12, T _m13, T _m14, T _m15, T _m16)
        {
            m1 = _m1;
            m2 = _m2;
            m3 = _m3;
        ...
        ~tmat44() {};
        //Creates a prospective projection matrix using Field of View, Aspect Ratio, and Near and Far clipping values.

        static tmat44<T> perspectiveProjectionMatrix(T field_of_view, T aspect_ratio, T near_clip, T far_clip)
        {
            tmat44<T> Out_Mat44;

            T t = near_clip * std::tan((field_of_view * ((T)3.141592653589793238462643383279 / 180.0f)) * 0.5f),
              r = t * aspect_ratio,
              l = -r,
              b = -t;
