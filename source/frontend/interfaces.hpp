...
namespace hive
{
    namespace js
    {
        ...
        napi_ref FloatVec3Prop_reference;
        napi_ref DoubleVec3Prop_reference;
        napi_ref ImageProp_reference;
        ...
        napi_value SpriteProp_wrapped_instance(void * hive_prop, napi_env env,
                                               napi_callback_info cb_info, bool APPLY_DESTRUCTOR);
        napi_value Drone_wrapped_instance(void * hive_prop, napi_env env,
                                          napi_callback_info cb_info, bool APPLY_DESTRUCTOR);
        napi_value FloatVec3Prop_wrapped_instance(void * hive_prop, napi_env env,
                                                  napi_callback_info cb_info,
                                                  bool APPLY_DESTRUCTOR);
        napi_value DoubleVec3Prop_wrapped_instance(void * hive_prop, napi_env env,
                                                   napi_callback_info cb_info,
                                                   bool APPLY_DESTRUCTOR);
        napi_value ImageProp_wrapped_instance(void * hive_prop, napi_env env,
                                              napi_callback_info cb_info, bool APPLY_DESTRUCTOR);
        napi_value MeshProp_wrapped_instance(void * hive_prop, napi_env env,
                                             napi_callback_info cb_info, bool APPLY_DESTRUCTOR);
        napi_value ShaderProgramProp_wrapped_instance(void * hive_prop, napi_env env,
                                                      napi_callback_info cb_info,
                                                      bool APPLY_DESTRUCTOR);
        ...
        napi_value Prop_type_getter(napi_env env, napi_callback_info info)
        {
            ...
            if (status != napi_ok)
                return JSError(env, "Could not read value as an unsigned short integer");
        ...
        napi_value Prop_connect_method(napi_env env, napi_callback_info info)
        {
            ...
            if (status != napi_ok || !IS_INSTANCE)
                return JSError(env, "Expected instance of Drone for argument A.");
        ...
        const napi_property_descriptor Prop_props[] = {
            ...
            {"byte_size", NULL, NULL, Prop_byte_size_getter, Prop_byte_size_setter, NULL,
             (napi_property_attributes)(napi_writable | napi_enumerable), NULL},
            {"connect", NULL, Prop_connect_method, NULL, NULL, NULL,
        ...
        napi_value SpriteProp_sprite_id_getter(napi_env env, napi_callback_info info)
        {
            ...
            if (status != napi_ok)
                return JSError(env, "Could not read value as an unsigned integer");
        ...
        const napi_property_descriptor SpriteProp_props[] = {
            {"sprite_id", NULL, NULL, SpriteProp_sprite_id_getter, SpriteProp_sprite_id_setter,
             NULL, (napi_property_attributes)(napi_writable | napi_enumerable), NULL}};
        ...
        napi_value SpriteProp_Constructor(napi_env env, napi_callback_info info)
        {
            ...
            if (arg_count == 1) {
                ...
                if (status != napi_ok)
                    std::cout << "Unable to get callback info for SpriteProp_Constructor"
                              << std::endl;
                else if (arg_type == napi_external) {
                    void * ptr;
                    ...
                    if (status == napi_ok) {
                        ...
                        std::cout << "wrapping instance of SpriteProp " << (long long)hive_prop
                                  << std::endl;
                    }
                }
            }
            ...
            if (!WRAP_EXISTING_POINTER) {
                ...
                std::cout << "creating instance of SpriteProp " << (long long)hive_prop
                          << std::endl;
            }
            ...
            if (WRAP_EXISTING_POINTER)
                ...
                status =
                    napi_wrap(env, this_arg, hive_prop, SpriteProp_Destructor, nullptr, nullptr);
        ...
        void SpriteProp_Register(napi_env env, napi_value property_registry)
        {
            ...
            if (status != napi_ok) {
                JSError(env, "Unable to dereference Prop_reference");
                return;
            };
            ...
            if (status != napi_ok) {
                JSError(env, "Unable to dereference SpriteProp_reference");
                return;
            };
        ...
        napi_value Drone_id_getter(napi_env env, napi_callback_info info)
        {
            ...
            /* VOID hive_struct_name: ID napi_value_name: value hive_prop_instance_name: prop
             * hive_prop_instance_member: id*/
        ...
        napi_value Drone_id_setter(napi_env env, napi_callback_info info)
        {
            ...
            /* VOID hive_struct_name: ID napi_value_name: args[0] hive_prop_instance_name: prop
             * hive_prop_instance_member: id*/
        ...
        napi_value Drone_connect_method(napi_env env, napi_callback_info info)
        {
            ...
            if (status != napi_ok || !IS_INSTANCE)
                return JSError(env, "Expected instance of Prop for argument A.");
        ...
        const napi_property_descriptor Drone_props[] = {
            {"id", NULL, NULL, Drone_id_getter, Drone_id_setter, NULL,
             (napi_property_attributes)(napi_writable | napi_enumerable), NULL},
            {"signalUpdate", NULL, Drone_signalUpdate_method, NULL, NULL, NULL,
             (napi_property_attributes)(napi_enumerable), NULL},
            {"connect", NULL, Drone_connect_method, NULL, NULL, NULL,
             (napi_property_attributes)(napi_enumerable), NULL},
            {"disconnect", NULL, Drone_disconnect_method, NULL, NULL, NULL,
             (napi_property_attributes)(napi_enumerable), NULL}};
            ...
            if (arg_count == 1) {
                ...
                if (status != napi_ok)
                    ...
                    if (status == napi_ok) {
                        ...
                        std::cout << "wrapping instance of Drone " << (long long)hive_prop
                                  << std::endl;
                    }
                }
            }
        ...
        void Drone_Register(napi_env env, napi_value property_registry)
        {
            ...
            status = napi_define_class(env, "Drone", NAPI_AUTO_LENGTH, &Drone_Constructor, nullptr,
                                       4, Drone_props, &result);
        ...
        const napi_property_descriptor FloatVec3Prop_props[] = {};


        void FloatVec3Prop_Destructor(napi_env env, void * finalize_data, void * finalize_hint)
        {

            FloatVec3Prop * prop = (FloatVec3Prop *)finalize_data;

            std::cout << "Deleting instance of FloatVec3Prop " << (long long)prop << std::endl;
                                                  ...
                                                  napi_callback_info cb_info, bool APPLY_DESTRUCTOR)
        {
            ...
            status = napi_get_reference_value(env, FloatVec3Prop_reference, &constructor);

            if (status != napi_ok)
                std::cout << "Unable to dereference FloatVec3Prop_reference" << std::endl;
            ...
            if (status != napi_ok)
                std::cout << "Unable to create JS instance of FloatVec3Prop" << std::endl;

            return object;
        }

        napi_value FloatVec3Prop_Constructor(napi_env env, napi_callback_info info)
        {

            FloatVec3Prop * hive_prop;
            ...
            if (status != napi_ok)
                std::cout << "Unable to get callback info for FloatVec3Prop_Constructor"
                          << std::endl;
            ...
            if (arg_count == 1) {
                ...
                if (status != napi_ok)
                    ...
                    if (status == napi_ok) {
                        ...
                        hive_prop = static_cast<FloatVec3Prop *>(ptr);

                        std::cout << "wrapping instance of FloatVec3Prop " << (long long)hive_prop
                                  << std::endl;
                    }
                }
            }
            ...
            if (!WRAP_EXISTING_POINTER) {
                hive_prop = FloatVec3Prop::construct();

                std::cout << "creating instance of FloatVec3Prop " << (long long)hive_prop
                          << std::endl;
            }
            ...
            if (WRAP_EXISTING_POINTER)
                ...
                status =
                    napi_wrap(env, this_arg, hive_prop, FloatVec3Prop_Destructor, nullptr, nullptr);

            if (status != napi_ok)
                std::cout << "Unable to wrap info for FloatVec3Prop_Constructor" << std::endl;


            return this_arg;
        }

        void FloatVec3Prop_Register(napi_env env, napi_value property_registry)
        {
            ...
            status = napi_define_class(env, "FloatVec3Prop", NAPI_AUTO_LENGTH,
                                       &FloatVec3Prop_Constructor, nullptr, 0, FloatVec3Prop_props,
                                       &result);

            status = napi_set_named_property(env, property_registry, "FloatVec3Prop", result);

            if (status != napi_ok) {
                std::cout << "FAILED TO CREATE  CLASS CONSTRUCTOR FOR FloatVec3Prop" << std::endl;
            } else {
                std::cout << "CREATED CLASS CONSTRUCTOR FloatVec3Prop" << std::endl;
            }

            status = napi_create_reference(env, result, 1, &FloatVec3Prop_reference);


            if (status != napi_ok) {
                std::cout << "FAILED TO CREATE REFERENCE FOR FloatVec3Prop" << std::endl;
            } else {
                std::cout << "CREATED CLASS CONSTRUCTOR FloatVec3Prop" << std::endl;
            }
        }
        const napi_property_descriptor DoubleVec3Prop_props[] = {};

        void DoubleVec3Prop_Destructor(napi_env env, void * finalize_data, void * finalize_hint)
        {

            DoubleVec3Prop * prop = (DoubleVec3Prop *)finalize_data;

            std::cout << "Deleting instance of DoubleVec3Prop " << (long long)prop << std::endl;
                                                   ...
                                                   bool APPLY_DESTRUCTOR)
        {
            ...
            status = napi_get_reference_value(env, DoubleVec3Prop_reference, &constructor);

            if (status != napi_ok)
                std::cout << "Unable to dereference DoubleVec3Prop_reference" << std::endl;
            ...
            if (status != napi_ok)
                std::cout << "Unable to create JS instance of DoubleVec3Prop" << std::endl;

            return object;
        }

        napi_value DoubleVec3Prop_Constructor(napi_env env, napi_callback_info info)
        {

            DoubleVec3Prop * hive_prop;
            ...
            if (status != napi_ok)
                std::cout << "Unable to get callback info for DoubleVec3Prop_Constructor"
                          << std::endl;
            ...
            if (arg_count == 1) {
                ...
                if (status != napi_ok)
                    ...
                    if (status == napi_ok) {
                        ...
                        hive_prop = static_cast<DoubleVec3Prop *>(ptr);

                        std::cout << "wrapping instance of DoubleVec3Prop " << (long long)hive_prop
                                  << std::endl;
                    }
                }
            }
            ...
            if (!WRAP_EXISTING_POINTER) {
                hive_prop = DoubleVec3Prop::construct();

                std::cout << "creating instance of DoubleVec3Prop " << (long long)hive_prop
                          << std::endl;
            }
            ...
            if (WRAP_EXISTING_POINTER)
                ...
                status = napi_wrap(env, this_arg, hive_prop, DoubleVec3Prop_Destructor, nullptr,
                                   nullptr);

            if (status != napi_ok)
                std::cout << "Unable to wrap info for DoubleVec3Prop_Constructor" << std::endl;


            return this_arg;
        }

        void DoubleVec3Prop_Register(napi_env env, napi_value property_registry)
        {
            ...
            status = napi_define_class(env, "DoubleVec3Prop", NAPI_AUTO_LENGTH,
                                       &DoubleVec3Prop_Constructor, nullptr, 0,
                                       DoubleVec3Prop_props, &result);

            status = napi_set_named_property(env, property_registry, "DoubleVec3Prop", result);

            if (status != napi_ok) {
                std::cout << "FAILED TO CREATE  CLASS CONSTRUCTOR FOR DoubleVec3Prop" << std::endl;
            } else {
                std::cout << "CREATED CLASS CONSTRUCTOR DoubleVec3Prop" << std::endl;
            }

            status = napi_create_reference(env, result, 1, &DoubleVec3Prop_reference);


            if (status != napi_ok) {
                std::cout << "FAILED TO CREATE REFERENCE FOR DoubleVec3Prop" << std::endl;
            } else {
                std::cout << "CREATED CLASS CONSTRUCTOR DoubleVec3Prop" << std::endl;
            }
        }
        const napi_property_descriptor ImageProp_props[] = {};

        void ImageProp_Destructor(napi_env env, void * finalize_data, void * finalize_hint)
        {

            ImageProp * prop = (ImageProp *)finalize_data;

            std::cout << "Deleting instance of ImageProp " << (long long)prop << std::endl;
                                              ...
                                              napi_callback_info cb_info, bool APPLY_DESTRUCTOR)
        {
            ...
            status = napi_get_reference_value(env, ImageProp_reference, &constructor);

            if (status != napi_ok)
                std::cout << "Unable to dereference ImageProp_reference" << std::endl;
            ...
            if (status != napi_ok)
                std::cout << "Unable to create JS instance of ImageProp" << std::endl;

            return object;
        }

        napi_value ImageProp_Constructor(napi_env env, napi_callback_info info)
        {
            ...
            if (status != napi_ok)
                std::cout << "Unable to get callback info for ImageProp_Constructor" << std::endl;
            ...
            if (arg_count == 1) {
                ...
                if (status != napi_ok)
                    std::cout << "Unable to get callback info for ImageProp_Constructor"
                              << std::endl;
                else if (arg_type == napi_external) {
                    void * ptr;
                    ...
                    if (status == napi_ok) {
                        ...
                        hive_prop = static_cast<ImageProp *>(ptr);

                        std::cout << "wrapping instance of ImageProp " << (long long)hive_prop
                                  << std::endl;
                    }
                }
            }
            ...
            if (!WRAP_EXISTING_POINTER) {
                hive_prop = ImageProp::construct();

                std::cout << "creating instance of ImageProp " << (long long)hive_prop << std::endl;
            }
            ...
            if (WRAP_EXISTING_POINTER)
                ...
                status =
                    napi_wrap(env, this_arg, hive_prop, ImageProp_Destructor, nullptr, nullptr);

            if (status != napi_ok)
                std::cout << "Unable to wrap info for ImageProp_Constructor" << std::endl;


            return this_arg;
        }

        void ImageProp_Register(napi_env env, napi_value property_registry)
        {
            ...
            status = napi_define_class(env, "ImageProp", NAPI_AUTO_LENGTH, &ImageProp_Constructor,
                                       nullptr, 0, ImageProp_props, &result);

            status = napi_set_named_property(env, property_registry, "ImageProp", result);

            if (status != napi_ok) {
                std::cout << "FAILED TO CREATE  CLASS CONSTRUCTOR FOR ImageProp" << std::endl;
            } else {
                std::cout << "CREATED CLASS CONSTRUCTOR ImageProp" << std::endl;
            }

            status = napi_create_reference(env, result, 1, &ImageProp_reference);


            if (status != napi_ok) {
                std::cout << "FAILED TO CREATE REFERENCE FOR ImageProp" << std::endl;
            } else {
                std::cout << "CREATED CLASS CONSTRUCTOR ImageProp" << std::endl;
            }
        }
        ...
        napi_value MeshProp_uploadData_method(napi_env env, napi_callback_info info)
        {
        ...
        const napi_property_descriptor MeshProp_props[] = {
            {"addVertex", NULL, MeshProp_addVertex_method, NULL, NULL, NULL,
             (napi_property_attributes)(napi_enumerable), NULL},
            {"uploadData", NULL, MeshProp_uploadData_method, NULL, NULL, NULL,
             (napi_property_attributes)(napi_enumerable), NULL}};
        ...
        napi_value MeshProp_Constructor(napi_env env, napi_callback_info info)
        {
            ...
            if (arg_count == 1) {
                ...
                if (status != napi_ok)
                    std::cout << "Unable to get callback info for MeshProp_Constructor"
                              << std::endl;
                else if (arg_type == napi_external) {
                    void * ptr;
                    ...
                    if (status == napi_ok) {
                        ...
                        std::cout << "wrapping instance of MeshProp " << (long long)hive_prop
                                  << std::endl;
                    }
                }
            }
        ...
        void MeshProp_Register(napi_env env, napi_value property_registry)
        {
            ...
            status = napi_define_class(env, "MeshProp", NAPI_AUTO_LENGTH, &MeshProp_Constructor,
                                       nullptr, 2, MeshProp_props, &result);
        ...
        napi_value ShaderProgramProp_configureProgramInterfaces_method(napi_env env,
        ...
        napi_value ShaderProgramProp_addVertexShader_method(napi_env env, napi_callback_info info)
        {
            ...
            status = napi_get_value_string_utf8(env, args[0], temp_A.data(), temp_A.size(),
                                                &string_length_A);
            if (status != napi_ok) return JSError(env, "Could not read argument A.");
            ...
            if (status != napi_ok)
                return JSError(env, "Could not write value as an unsigned integer");
        ...
        napi_value ShaderProgramProp_addTesselationEvalShader_method(napi_env env,
                                                                     napi_callback_info info)
        {
        ...
        napi_value ShaderProgramProp_addTesselationControlShader_method(napi_env env,
                                                                        napi_callback_info info)
        {
        ...
        napi_value ShaderProgramProp_configureProgramInputs_method(napi_env env,
                                                                   napi_callback_info info)
        {
        ...
        const napi_property_descriptor ShaderProgramProp_props[] = {
            {"configureProgramInterfaces", NULL,
             ShaderProgramProp_configureProgramInterfaces_method, NULL, NULL, NULL,
             (napi_property_attributes)(napi_enumerable), NULL},
            {"setupStaticInputs", NULL, ShaderProgramProp_setupStaticInputs_method, NULL, NULL,
             NULL, (napi_property_attributes)(napi_enumerable), NULL},
            {"addVertexShader", NULL, ShaderProgramProp_addVertexShader_method, NULL, NULL, NULL,
             (napi_property_attributes)(napi_enumerable), NULL},
            {"addFragShader", NULL, ShaderProgramProp_addFragShader_method, NULL, NULL, NULL,
             (napi_property_attributes)(napi_enumerable), NULL},
            {"addComputeShader", NULL, ShaderProgramProp_addComputeShader_method, NULL, NULL, NULL,
             (napi_property_attributes)(napi_enumerable), NULL},
            {"addGeometryShader", NULL, ShaderProgramProp_addGeometryShader_method, NULL, NULL,
             NULL, (napi_property_attributes)(napi_enumerable), NULL},
            {"addTesselationEvalShader", NULL, ShaderProgramProp_addTesselationEvalShader_method,
             NULL, NULL, NULL, (napi_property_attributes)(napi_enumerable), NULL},
            {"addTesselationControlShader", NULL,
             ShaderProgramProp_addTesselationControlShader_method, NULL, NULL, NULL,
             (napi_property_attributes)(napi_enumerable), NULL},
            {"compileShader", NULL, ShaderProgramProp_compileShader_method, NULL, NULL, NULL,
             (napi_property_attributes)(napi_enumerable), NULL},
            {"configureProgramInputs", NULL, ShaderProgramProp_configureProgramInputs_method, NULL,
             NULL, NULL, (napi_property_attributes)(napi_enumerable), NULL}};
        ...
        napi_value ShaderProgramProp_Constructor(napi_env env, napi_callback_info info)
        {
            ...
            if (status != napi_ok)
                std::cout << "Unable to get callback info for ShaderProgramProp_Constructor"
                          << std::endl;
            ...
            if (arg_count == 1) {
                ...
                if (status != napi_ok)
                    std::cout
                        << "Unable errorto get callback info for ShaderProgramProp_Constructor"
                        << std::endl;
                else if (arg_type == napi_external) {
                    void * ptr;
                    ...
                    if (status == napi_ok) {
                        ...
                        std::cout << "wrapping instance of ShaderProgramProp "
                                  << (long long)hive_prop << std::endl;
                    }
                }
            }
            ...
            if (!WRAP_EXISTING_POINTER) {
                ...
                std::cout << "creating instance of ShaderProgramProp " << (long long)hive_prop
                          << std::endl;
            }
            ...
            if (WRAP_EXISTING_POINTER)
                ...
                status = napi_wrap(env, this_arg, hive_prop, ShaderProgramProp_Destructor, nullptr,
                                   nullptr);
        ...
        void ShaderProgramProp_Register(napi_env env, napi_value property_registry)
        {
            ...
            status = napi_define_class(env, "ShaderProgramProp", NAPI_AUTO_LENGTH,
                                       &ShaderProgramProp_Constructor, nullptr, 10,
                                       ShaderProgramProp_props, &result);

            status = napi_set_named_property(env, property_registry, "ShaderProgramProp", result);

            if (status != napi_ok) {
                std::cout << "FAILED TO CREATE  CLASS CONSTRUCTOR FOR ShaderProgramProp"
                          << std::endl;
            } else {
        ...
        void RegisterInterfaces(napi_env env, napi_value registry)
        {
            ...
            FloatVec3Prop_Register(env, registry);
            DoubleVec3Prop_Register(env, registry);
            ImageProp_Register(env, registry);
